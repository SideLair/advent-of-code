...
def move(instructions):
    ...
    for instruction in instructions:
        ...
        if instruction[0] in 'EW':
            current_coords = (current_coords[0] + instruction[1] * moves[instruction[0]], current_coords[1])
        elif instruction[0] in 'NS':
            current_coords = (current_coords[0], current_coords[1] + instruction[1] * moves[instruction[0]])
